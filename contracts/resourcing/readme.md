Resourcing Application using Blockchain
=======================================

Overview
---------

The Resourcing Blockchain application expresses a workflow between a party requiring consulting
and a consultant responding to the request.  The state transition diagram
...
| Consultant |  The consultant that responds to the Requestor |
